				...
				<div class="col-xs-12 destinationHolder">
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						<a href="trains.php" style="color: black;">
							...
							<div class="col-xs-12 icons text-center">
								<img src="images/icons/train.png" alt="train" class="iconsDim text-center"/>
							</div>
		...
		<!-- FOOTER SECTION STARTS -->
				...
				<div class="footerMod col-sm-12">
					...
					<div class="col-sm-4">
						...
						Kigali,Rusisi <br> Burera,Bugesera
						</div>
				
						<div class="footerText">
							E-mail: souvenirgisubizo2004@gmail.com
						</div>
					...
					<div class="copyrightContainer">
						<div class="copyright">
						Copyright &copy; 2021 gisubizo souvenir
						</div>
					</div>
					</div>
