   							...
   							<div class="form-group">
   								 <label for="city">City:<p> </p></label>
      								...
      								<select id= "city"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select City" name="city" required>
       									<option value="musanze" data-tokens="MU musanze">musanze</option>
        								<option value="Kigali" data-tokens="KI kigali">Kigali</option>
        								<option value="Kakiru" data-tokens="KA kakiru">Kakiru</option>
        								<option value="huye" data-tokens="HU huye">huye</option>
        								<option value="Rusizi" data-tokens="RU rusizi">Rusizi</option>
        								<option value="burera" data-tokens="BU burera">burera</option>
        								<option value="Nyaruguru" data-tokens="NY nyaruguru">Nyaruguru</option>
        								<option value="Bugesera" data-tokens="BU bugesera">Bugesera</option>
        								<option value="Gatsibo" data-tokens="GA gatsibo">Gatsibo</option>
        								<option value="Nyabihu" data-tokens="NY nyabihu">Nyabihu</option>
      								</select>
							</div>
            			</div>
							...
							<div  class="col-sm-4">
								...
								<div class="listItem">
									...
									<div class="info">
										...
										3-star hotels averaging 200000
										
									</div>
									
									<div class="info">
										
										5-star hotels averaging 65000
